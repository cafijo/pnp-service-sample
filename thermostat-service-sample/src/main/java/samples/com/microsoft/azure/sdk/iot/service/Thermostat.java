...
public class Thermostat {
    ...
    private static void RunSample() throws IOException, IotHubException {
        ...
        GetAndUpdateTwin(25.6F);

        System.out.println("Invoke a method InvokeGetMaxMinMethod");
        InvokeGetMaxMinMethod();

        System.out.println("Invoke a method InvokeResetTemperature" );
        InvokeResetTemperature();

        System.out.println("Get Twin model Id and Update Twin");
        GetAndUpdateTwin(40.5F);

        System.out.println("Invoke a method InvokeReboot");
        InvokeReboot();
    }
    ...
    private static void GetAndUpdateTwin(float temperature) throws IOException, IotHubException {
        ...
        double propertyValue = temperature;
        ...
        System.out.println("The updated reported properties: " + twin.getReportedProperties().values().iterator().next());
    }

    private static void InvokeGetMaxMinMethod() throws IOException, IotHubException {
    ...
    private static void InvokeResetTemperature() throws IOException, IotHubException {
        // The method to invoke for a device without components should be "methodName" as defined in the DTDL.
        String methodToInvoke = "resetTemperature";
        System.out.println("Invoking method: " + methodToInvoke);
    ...
    private static void InvokeReboot() throws IOException, IotHubException {
        // The method to invoke for a device without components should be "methodName" as defined in the DTDL.
